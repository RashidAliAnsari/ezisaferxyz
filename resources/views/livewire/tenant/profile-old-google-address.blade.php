            ...
            <form wire:submit.prevent="submit" autocomplete="off">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="autocomplete" class="form-control"
                                    placeholder="Type your Address..." autocomplete="off" wire:ignore>
                        ...
                        <div class="col-sm-6 col-md-6">
                            <div class="form-group">
                                <label class="form-label">Formatted Address<span
                                        class="input-required">*</span></label>
                                <input type="text" class="form-control" placeholder="Formatted Address" readonly
                                    wire:model.debounce.500ms="form.address">
...
@section('js')
    ...
    <script type="text/javascript">
        document.addEventListener('livewire:load', function() {
            // Livewire.on('tempChanged', function() {
            // console.log('temp changed');
            // var someValue = @this.form.fax_no;
            // console.log(someValue);
            // @this.form.fax_no = 'some site';
            // @this.set('form.fax_no', '666');
            // console.log(@this.form.fax_no);

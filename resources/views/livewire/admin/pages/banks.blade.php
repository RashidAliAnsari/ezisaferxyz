...
<div class="row">
                        ...
                        <table class="table table-bordered text-nowrap key-buttons agencies" id="example2">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-20p border-bottom-0">Bank Name</th>
                                    <th class="wd-20p border-bottom-0">Country Name</th>
                                    <th class="wd-20p border-bottom-0">Is Active</th>
                    ...
                    <div class="modal-body">
                        <div class="">
                            <div class="form-group">
                                ...
                                @error('form.bank_name')<p class="help-block input-error modal-input-error">
                                        {{ $message }}</p>
                                @enderror
                            </div>
                            <div class="form-group">
    ...
    <x-admin.banks-update></x-admin.banks-update>

                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <span class="mb-1 text-muted"><span class="text-danger"><i
                                    class="fa fa-caret-down  mr-1"></i> 43.2</span> last month</span>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-6">
                ...
                <div class="d-flex ml-auto">
                    <div class="btn-group mb-0">
                        <button type="button" class="btn btn-white dropdown-toggle" data-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false">This week</button>
                    ...
                    <ul class="timeline mb-0">
                        <li class="mt-0 media media-lg">
                            ...
                            <div class="media mt-0">
                                <div class="media-body">
                                    <h6 class="mb-1"><a href="#" class="font-weight-semibold fs-17">Angular
                                            Project</a><span class="badge badge-success ml-2">Completed</span></h6>
                        ...
                        <li class="mt-0 media media-lg">
                            <div class="media mt-0">
                                ...
                                <div class="media-body">
                                    <h6 class="mb-1"><a href="#" class="font-weight-semibold fs-17">Html
                                            Project</a><span class="badge badge-secondary ml-2">Hold</span></h6>
                        ...
                        <li class="mt-0 media media-lg">
                            <div class="media mt-0">
                                ...
                                <div class="media-body">
                                    <h6 class="mb-1"><a href="#" class="font-weight-semibold fs-17">Php
                                            Project</a><span class="badge badge-primary ml-2">Running</span></h6>
        ...
        <div class="card">
            ...
            <div class="card-body pt-0 border-top-0">
                <div class="row mt-4 no-gutters">
                    <div class="col">
                        <div class="text-muted mb-1 fs-13 d-flex">
                            <div class="w-3 h-3 bg-primary mr-2 mt-1 brround"></div> Running
                        </div>
                    </div>
                    <div class="col">
                        <div class="text-muted mb-1 fs-13 d-flex">
                            <div class="w-3 h-3 bg-secondary mr-2 mt-1 brround"></div> Pending
                        </div>
                    </div>
                    <div class="col">
                        <div class="text-muted mb-1 fs-13 d-flex">
                            <div class="w-3 h-3 bg-success mr-2 mt-1 brround"></div> Completed
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="col-xl-4 col-md-6 col-lg-4">
        <div class="card overflow-hidden">
            ...
            <div class="p-4 scrollbar h-330" id="scrollbar">
                <div class="activity">
                    <img src="{{ URL::asset('assets/images/users/14.jpg') }}" alt=""
                        class="img-activity shadow3 border-primary">
                    <div class="time-activity">
                        <div class="item-activity">
                            <p class="mb-0 font-weight-bold">Adam Berry <span class="text-muted">Add a new
                                    projects </span> AngularJS Template</p>
                            <small class="text-muted ">30 mins ago</small>
                        </div>
                    </div>
                    <img src="{{ URL::asset('assets/images/users/10.jpg') }}" alt=""
                        class="img-activity shadow3 border-secondary">
                    <div class="time-activity">
                        <div class="item-activity">
                            <p class="mb-0 font-weight-bold">Irene Hunter <span class="text-muted"> Add a new
                                    projects </span>Free HTML Template</p>
                            <small class="text-muted ">1 days ago</small>
                        </div>
                    </div>
                    <img src="{{ URL::asset('assets/images/users/4.jpg') }}" alt=""
                        class="img-activity shadow3 border-success">
                    <div class="time-activity">
                        <div class="item-activity">
                            <p class="mb-0 font-weight-bold">John Payne<span class="text-muted"> Add a new
                                    projects </span>Free PSD Template</p>
                            <small class="text-muted ">3 days ago</small>
                        </div>
                    </div>
                    <img src="{{ URL::asset('assets/images/users/8.jpg') }}" alt=""
                        class="img-activity shadow3 border-danger">
                    <div class="time-activity">
                        <div class="item-activity">
                            <p class="mb-0 font-weight-bold">Julia Hardacre<span class="text-muted"> Add a new
                                    projects </span>Free UI Template</p>
        ...
        <div class="card overflow-hidden">
            ...
            <div class="p-4 scrollbar2 h-330" id="scrollbar2">
                <div class="activity">
                    ...
                    <div class="time-activity">
                        <div class="item-activity">
                            <p class="mb-0 font-weight-bold">New Project <span class="text-muted">Issue
                                    Fixed</span></p>
                            <small class="text-muted ">30 mins ago</small>
                        </div>
                    </div>
                    <img src="{{ URL::asset('assets/images/users/2.jpg') }}" alt=""
                        class="img-activity shadow3 border-secondary">
                    <div class="time-activity">
                        <div class="item-activity">
                            <p class="mb-0 font-weight-bold">Wordpress Project<span class="text-muted"> New theme
                                    updated </span></p>
                            <small class="text-muted ">1 days ago</small>
                        </div>
                    </div>
                    <img src="{{ URL::asset('assets/images/users/1.jpg') }}" alt=""
                        class="img-activity shadow3 border-success">
                    <div class="time-activity">
                        <div class="item-activity">
                            <p class="mb-0 font-weight-bold">E-Commerce<span class="text-muted">Plugin Issue Fixed
                                    and Updated</span></p>
                            <small class="text-muted ">3 days ago</small>
                        </div>
                    </div>
                    <img src="{{ URL::asset('assets/images/users/3.jpg') }}" alt=""
                        class="img-activity shadow3 border-danger">
                    <div class="time-activity">
                        <div class="item-activity">
                            <p class="mb-0 font-weight-bold">New Theme<span class="text-muted"> Updated in
                                    Site</span></p>
                            <small class="text-muted ">5 days ago</small>
                        </div>
                    </div>

							...
							<div class="col-xl-3 col-lg-6 col-md-12">
								<div class="card">
									<div class="card-body text-center">
										...
										<small class="mb-1 text-muted"><small class="text-success"><i class="fa fa-caret-up  mr-1"></i> 19.8</small> vs 36,144 than last month</small>
									</div>
								</div>
							</div>
							<div class="col-xl-3 col-lg-6 col-md-12">
								<div class="card">
									<div class="card-body text-center">
										...
										<small class="mb-1 text-muted"><small class="text-danger"><i class="fa fa-caret-down  mr-1"></i> 43.2</small> vs $5,699 than last month</small>
									</div>
								</div>
							</div>
											...
											<div class="card-body text-center">
												...
												<div class="row mt-5">
													<div class="col text-center">
														<span class="text-muted float-right"><div class="w-3 h-3 bg-primary br-3 mr-1 mt-1 float-left"></div> Page views</span>
													</div>
													<div class="col text-center">
														<span class="text-muted float-left"><div class="w-3 h-3 bg-secondary br-3 mr-1 mt-1 float-left"></div> New Visitors</span>
													</div>
												</div>
											</div>
										</div>
									...
									<div class="table-responsive card-body">
										<table class="table mg-b-0 text-nowrap">
											...
											<tbody>
												...
												<tr>
													<td><i class="flag flag-gb flag-icon-squared mr-2"></i> <strong>United Kingdom</strong></td>
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="row no-gutters">
											<div class="col text-center">
												<span class="text-muted float-left"><div class="w-4 h-3 bg-success br-3 mr-1 mt-1 float-left"></div> Local</span>
											</div>
											<div class="col text-center">
												<span class="text-muted float-left"><div class="w-4 h-3 bg-primary br-3 mr-1 mt-1 float-left"></div> Domestic</span>
											</div>
											<div class="col col-auto text-center">
												<span class="text-muted float-left"><div class="w-4 h-3 bg-danger br-3 mr-1 mt-1 float-left"></div> International</span>
											</div>
										</div>
									</div>
								</div>
												...
												<table class="table card-table table-vcenter text-nowrap mb-0 border">
													...
													<tbody>
														<tr>
															...
															<td class="w-1 text-center"><a href="#" class="btn btn-icon2 btn-white"><i class="fe fe-eye"></i></a></td>
														</tr>
														<tr>
